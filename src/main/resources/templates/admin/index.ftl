                    ...
                    <ul class="nav navbar-top-links navbar-right">
                        <li class="dropdown">
                            <a class="dropdown-toggle count-info" data-toggle="dropdown" href="#">
                                <i class="fa fa-user"></i> <span class="label label-primary"></span>【<@shiro.principal type="com.project.ggkj.entity.User" property="nickName"/>】
                            </a>
                                ...
                                <li>
                                    <a onclick="updatePwd()">
                                        <div>
                                            ...
                                            <span class="pull-right text-muted small"><@shiro.principal type="com.project.ggkj.entity.User" property="userName"/></span>
                                        </div>
                                    </a>
                                </li>
                                <li>
